 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2009-06-22 21:32:15 +0200 (Mo, 22 Jun 2009) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 5102 $
 * 
 * $Id: smf2.bridge.php 5102 2009-06-22 19:32:15Z ghoschdi $
 */
   ...
   function login($username, $password, $auto_login)
   {
		...
		$db_cms->sql_connect($cms_host,$cms_db,$cms_user,$cms_pass,false);
			...
			if ( $rut_row )
			{
                ...
                if ((sha1(strtolower($username) . htmlspecialchars_decode(stripslashes($password))) == $rut_row['passwd']) && $right_group)
                {
