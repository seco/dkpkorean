...
echo '
      ...
      <input type="text" name="raid_value" size="8" maxlength="7" value="' . ((isset($this->_tpldata['.'][0]['RAID_VALUE'])) ? $this->_tpldata['.'][0]['RAID_VALUE'] : '') . '" class="input" />' . ((isset($this->_tpldata['.'][0]['FV_VALUE'])) ? $this->_tpldata['.'][0]['FV_VALUE'] : '') . ' ';// IF ! S_ADD
if (! $this->_tpldata['.'][0]['S_ADD']) { 
echo '/ ' . ((isset($this->_tpldata['.'][0]['L_SHOULD_BE'])) ? $this->_tpldata['.'][0]['L_SHOULD_BE'] : ((isset($user->lang['SHOULD_BE'])) ? $user->lang['SHOULD_BE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'SHOULD_BE'))) . ' 	}')) . ': <span class="positive">' . ((isset($this->_tpldata['.'][0]['CORRECT_RAID_VALUE'])) ? $this->_tpldata['.'][0]['CORRECT_RAID_VALUE'] : '') . ' </span> ' . ((isset($this->_tpldata['.'][0]['L_ZERO'])) ? $this->_tpldata['.'][0]['L_ZERO'] : ((isset($user->lang['ZERO'])) ? $user->lang['ZERO'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'ZERO'))) . ' 	}')) . '';// ENDIF
}
echo '
    </td>
  </tr>
