...
echo '
  <tr class="' . ((isset($this->_tpldata['adjustments_row.'][$_adjustments_row_i]['ROW_CLASS'])) ? $this->_tpldata['adjustments_row.'][$_adjustments_row_i]['ROW_CLASS'] : '') . '">
    <td width="16" nowrap="nowrap" align="center"><a href="' . ((isset($this->_tpldata['adjustments_row.'][$_adjustments_row_i]['U_ADD_ADJUSTMENT'])) ? $this->_tpldata['adjustments_row.'][$_adjustments_row_i]['U_ADD_ADJUSTMENT'] : '') . '"><img src="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'images/glyphs/edit.png" width="16" height="16" alt="Edit" /></a></td>
...
echo '
  <tr class="rowhead">
    ...
    <th align="left" width="150" nowrap="nowrap"><a href="' . ((isset($this->_tpldata['.'][0]['U_LIST_ADJUSTMENTS'])) ? $this->_tpldata['.'][0]['U_LIST_ADJUSTMENTS'] : '') . 'o=' . ((isset($this->_tpldata['.'][0]['O_RAID'])) ? $this->_tpldata['.'][0]['O_RAID'] : '') . '&amp;start=' . ((isset($this->_tpldata['.'][0]['START'])) ? $this->_tpldata['.'][0]['START'] : '') . '">' . ((isset($this->_tpldata['.'][0]['L_MULTI_EVENTNAME'])) ? $this->_tpldata['.'][0]['L_MULTI_EVENTNAME'] : ((isset($user->lang['MULTI_EVENTNAME'])) ? $user->lang['MULTI_EVENTNAME'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'MULTI_EVENTNAME'))) . ' 	}')) . '</a></a></th>
...
echo '
  <tr class="' . ((isset($this->_tpldata['adjustments_row.'][$_adjustments_row_i]['ROW_CLASS'])) ? $this->_tpldata['adjustments_row.'][$_adjustments_row_i]['ROW_CLASS'] : '') . '">
    ...
    <td width="150" nowrap="nowrap">' . ((isset($this->_tpldata['adjustments_row.'][$_adjustments_row_i]['RAID_NAME'])) ? $this->_tpldata['adjustments_row.'][$_adjustments_row_i]['RAID_NAME'] : '') . '</td>
...
echo ' 
  <tr>
    <th colspan="6" class="footer">' . ((isset($this->_tpldata['.'][0]['LISTADJ_FOOTCOUNT'])) ? $this->_tpldata['.'][0]['LISTADJ_FOOTCOUNT'] : '') . '</th>
  </tr>
';// ENDIF
}
echo '
