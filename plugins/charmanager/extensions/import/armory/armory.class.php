 ...
 * @version     $Rev: 2560 $
 * 
 * $Id: armory.class.php 2560 2008-08-16 23:47:56Z wallenium $
 */
...
class ArmoryCharLoader
{
	...
	function BuildLink($loc, $user, $server){
		$server	= ($this->stringUTF8) ? stripslashes(rawurlencode($server)) : stripslashes(rawurlencode(utf8_encode($server)));
		$user 	= ($this->stringUTF8)	? stripslashes(rawurlencode($user)) : stripslashes(rawurlencode(utf8_encode($user)));
