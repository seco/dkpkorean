...
//Help-messages
$lang['dl_help_file_types']				= 'Faste here (separated with commas) all allowable file extensions. This applies only to files that are uploaded, not to URLs. As file-extension, only use the letters after the last dot, e.g. "tar.gz" is not correct, but "gz".';
