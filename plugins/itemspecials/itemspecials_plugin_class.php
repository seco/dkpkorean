 ...
 * @version     $Rev: 5002 $
 * 
 * $Id: itemspecials_plugin_class.php 5002 2009-06-01 11:23:19Z wallenium $
 */
   ...
   function itemspecials_plugin_class($pm){
    ...
    $this->additional_data = array(
        ...
        // Add Menus
		    ...
		    // Define installation
        // -----------------------------------------------------
          $sql = "CREATE TABLE IF NOT EXISTS __itemspecials_config (
		      ...
		      $sql = "CREATE TABLE IF NOT EXISTS __itemspecials_plugins (
          ...
          $sql = "CREATE TABLE IF NOT EXISTS __itemspecials_items (
          ...
          $sql = "INSERT INTO __itemspecials_plugins (`plugin_name`, `plugin_installed`, `plugin_path`, `plugin_contact`, `plugin_version`)  VALUES ('Normal Calculation', '1', 'setright_plugin1', 'webmaster@wallenium.de', '1.0.0');";
		      $this->add_sql(SQL_INSTALL, $sql);

		      $sql = "CREATE TABLE IF NOT EXISTS __itemspecials_custom (
    ...
    if (!($this->pm->check(PLUGIN_INSTALLED, 'itemspecials'))){
		...
		// Uninstall
		$this->add_sql(SQL_UNINSTALL, "DROP TABLE IF EXISTS __itemspecials_config");
		$this->add_sql(SQL_UNINSTALL, "DROP TABLE IF EXISTS __itemspecials_plugins");
		$this->add_sql(SQL_UNINSTALL, "DROP TABLE IF EXISTS __itemspecials_custom");
		$this->add_sql(SQL_UNINSTALL, "DROP TABLE IF EXISTS __itemspecials_items");
    }
	...
	function InsertIntoTable($fieldname,$insertvalue){
  	global $eqdkp_root_path, $user, $SID, $table_prefix;
		$sql = "INSERT INTO __itemspecials_config VALUES ('".$fieldname."', '".$insertvalue."');";
		$this->add_sql(SQL_INSTALL, $sql);
  }
