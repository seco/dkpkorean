...
class tss2info {
  ...
  function ShortenMembername($name){
    $myShortenValue = (is_numeric($this->plusconfig['pk_ts_memnamelength'])) ? $this->plusconfig['pk_ts_memnamelength'] : 16;
    if ($this->plusconfig['pk_ts_shortmemnames']  == '1' && strlen($name) > $myShortenValue) {
      $myname = substr($name, 0, $myShortenValue - 1)."...";
    }else{
      $myname = $name;
    }
    return $myname;
	...
	function getInfo() {
		$myChannel = (trim($this->plusconfig['pk_ts_channel_name']) != '') ? explode(',',$this->plusconfig['pk_ts_channel_name']) : '';
		if (is_array($myChannel)) array_walk($myChannel , create_function('&$temp', '$temp = trim(htmlspecialchars_decode($temp));'));
		...
		if($this->socket == false) {
		  ...
		  do {
		    ...
		    if($playerid != "OK") {
		      ...
		      "playername" => $this->stripQuotes($this->ShortenMembername($playername)));
		    }// end if
		  } while($playerid != "OK");
	...
	//////////////////////////////////////////////////////////
			  ...
			  $tsv_username = $this->alternativer_nick;
				...
				foreach($this->channelList as $channelInfo) {
				 if ($myChannel == '' OR in_array($channelInfo['channelname'], $myChannel)) {
				            ...
				            <table border="0" width="100%" cellpadding="0" cellspacing="0">
				              <tr nowrap>
				                <td class="channel" width="25" valign="top" nowrap>
				                	<img width="5" height="13" src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/blank.gif" border="0" alt="">
				                	<img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/channel.gif" width="20" height="13" border="0" alt="">
				                </td>
				        ...
				        <tr>
				          <td>
				            <table border="0" width="100%" cellpadding="0" cellspacing="0">
				              ...
				              $ts_viewer_ausgabe .= '
				                <td width="40" nowrap>
				                	<img width="5" height="16" src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/blank.gif" border="0" alt=""><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/blank.gif" width="15" height="16" border="0" alt=""><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/'.$this->TS_attribute($playerInfo['attribute']).'" width="20" height="16" border="0" alt=""></td>';
				              } else {
				              $player_without_channel[] = $playerInfo;
				              $ts_viewer_ausgabe .= '
				                <td width="20" nowrap><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/'.$this->TS_attribute($playerInfo['attribute']).'" width="20" height="16" border="0" alt=""></td>';
				              }
				              $ts_viewer_ausgabe .= '
				      ...
				      foreach($this->channelList as $subchannelInfo) {
				        ...
				        <tr>
				          <td valign="top">
				            <table border="0" width="100%" cellpadding="0" cellspacing="0">
				              <tr>
				                <td class="channel" width="40" valign="top" nowrap><img width="5" height="13" src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/blank.gif" border="0" alt=""><img width="15" height="13" src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/blank.gif" border="0" alt=""><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/channel.gif" width="20" height="13" border="0" alt=""></td>
				        ...
				        <tr>
				          <td>
				            <table border="0" width="100%" cellpadding="0" cellspacing="0">
				              ...
				              $player_without_channel[] = $playerInfo;
				              $ts_viewer_ausgabe .= '
				                <td class="player" width="20" nowrap><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/'.$this->TS_attribute($playerInfo['attribute']).'" width="20" height="16" border="0" alt=""></td>';
				              }
				              $ts_viewer_ausgabe .= '
			  ...
			  $htmlOutPut .= '
			        <tr>
			          <td>
			            <table border="0" width="100%" cellpadding="0" cellspacing="0">
			              <tr>
			                <td class="teamspeak" width="33" nowrap><img src="'.$this->rpath.'portal/teamspeak/TeamSpeakViewer/images/teamspeak.gif" width="33"height="18" border="0" alt=""></td><td class="teamspeak" width="100%">'.$this->sitetitle.'</td>
			              </tr>
			            </table>
			          </td>
			        </tr>';
