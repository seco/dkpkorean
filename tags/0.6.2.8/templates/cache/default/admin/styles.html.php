...
echo '
  <tr class="' . ((isset($this->_tpldata['styles_row.'][$_styles_row_i]['ROW_CLASS'])) ? $this->_tpldata['styles_row.'][$_styles_row_i]['ROW_CLASS'] : '') . '">
    <td width="16" nowrap="nowrap"><a href="' . ((isset($this->_tpldata['styles_row.'][$_styles_row_i]['U_EDIT_STYLE'])) ? $this->_tpldata['styles_row.'][$_styles_row_i]['U_EDIT_STYLE'] : '') . '"><img src="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'images/glyphs/edit.png" width="16" height="16" alt="Edit" /></a></td>
