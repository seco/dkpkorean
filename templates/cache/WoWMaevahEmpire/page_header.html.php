...
.row1viewnews { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR1'])) ? $this->_tpldata['.'][0]['T_TR_COLOR1'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda01.gif\');}
.row2viewnews { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda02.gif\');}
...
.credits {font-size: 10px; color: #999999; font-family: Verdana, Arial, Tahoma ; letter-spacing: -1px;}
a.credits {font-size: 10px; color: #999999; font-family: Verdana, Arial, Tahoma ; letter-spacing: -1px;}
