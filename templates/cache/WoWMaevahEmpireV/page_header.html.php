...
echo '
<link rel="shortcut icon" href="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'templates/WoWMaevahEmpireV/images/favicon.png" type="image/png">
<link rel="icon" href="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'templates/WoWMaevahEmpireV/images/favicon.png" type="image/png">
...
BODY { font-family: ' . ((isset($this->_tpldata['.'][0]['T_FONTFACE1'])) ? $this->_tpldata['.'][0]['T_FONTFACE1'] : '') . '; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR1'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR1'] : '') . '; margin-left: 1.20%; margin-right: 1.44%; margin-top: 0.55%; background-color: #' . ((isset($this->_tpldata['.'][0]['T_BODY_BACKGROUND'])) ? $this->_tpldata['.'][0]['T_BODY_BACKGROUND'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda01.gif\'); }
...
TABLE.border01 { border: 1px #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . ' solid; }

th { font-weight: bold; color: #' . ((isset($this->_tpldata['.'][0]['T_HEADER_LINK'])) ? $this->_tpldata['.'][0]['T_HEADER_LINK'] : '') . '; background-color: #' . ((isset($this->_tpldata['.'][0]['T_TH_COLOR1'])) ? $this->_tpldata['.'][0]['T_TH_COLOR1'] : '') . '; white-space: nowrap; font-variant: small-caps; }
...
th { font-weight: bold; color: #' . ((isset($this->_tpldata['.'][0]['T_HEADER_LINK'])) ? $this->_tpldata['.'][0]['T_HEADER_LINK'] : '') . '; background-color: #' . ((isset($this->_tpldata['.'][0]['T_TH_COLOR1'])) ? $this->_tpldata['.'][0]['T_TH_COLOR1'] : '') . '; white-space: nowrap; background-image: url(' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/cellpic1.gif); height: 29px;}
tr, td { font-family: ' . ((isset($this->_tpldata['.'][0]['T_FONTFACE1'])) ? $this->_tpldata['.'][0]['T_FONTFACE1'] : '') . '; ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR1'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR1'] : '') . ';}
...
.row1 { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR1'])) ? $this->_tpldata['.'][0]['T_TR_COLOR1'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgroundb01.gif\');}
.row2 { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgroundb02.gif\');}

.row1viewnews { white-space: normal;background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR1'])) ? $this->_tpldata['.'][0]['T_TR_COLOR1'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda01.gif\');}
.row2viewnews { white-space: normal;background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . '; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda02.gif\');}

.quote1 { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . '; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; line-height: 125%; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda03.gif\') }
.quote2 { background-color: #' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR1'])) ? $this->_tpldata['.'][0]['T_TR_COLOR1'] : '') . '; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; line-height: 125%; background-image:url(\'' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/wowmaevahempirebackgrounda03.gif\') }
...
.maintitle { font-variant:small-caps; font-size: 18px; font-weight: bold; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR1'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR1'] : '') . '; font-family: Verdana, Arial, Tahoma; }
.subtitle  { font-size: 12px; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR1'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR1'] : '') . '; }
.credits {font-size: 10px; color: #999999; font-family: Verdana, Arial, Tahoma; letter-spacing: -1px;white-space: normal;}
a.credits {font-size: 10px; color: #999999; font-family: Verdana, Arial, Tahoma; letter-spacing: -1px;white-space: normal;}

.menu { font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR2'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR2'] : '') . '; }
.menu a:link, .menu a:active, .menu a:visited { text-decoration: none; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR2'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR2'] : '') . '; }
.menu a:hover { text-decoration: underline; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE2'])) ? $this->_tpldata['.'][0]['T_FONTSIZE2'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_BODY_HLINK'])) ? $this->_tpldata['.'][0]['T_BODY_HLINK'] : '') . '; }

.small { font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE1'])) ? $this->_tpldata['.'][0]['T_FONTSIZE1'] : '') . 'px; }
.smallright { font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE1'])) ? $this->_tpldata['.'][0]['T_FONTSIZE1'] : '') . 'px; text-align: right; color: #AAAAAA;}
...
echo '
<table width="100%" border="0" cellspacing="1" cellpadding="2" class="borderless" align=center>
  <tr>
    <td width="100%" nowrap="nowrap" align=center><img src="' . ((isset($this->_tpldata['.'][0]['HEADER_LOGO'])) ? $this->_tpldata['.'][0]['HEADER_LOGO'] : '') . '" alt="Logo" /><br /></td>
  </tr>
</table>
