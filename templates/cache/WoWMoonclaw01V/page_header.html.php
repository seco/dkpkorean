...
th { font-weight: bold; color: #FFDD33; background-color: #020725; white-space: nowrap; background-image: url(' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/cellpic1.gif); height: 28px;}
tr, td { font-family: Verdana, Tahoma, Arial; font-size: 11px; color: #FFFFFF; }

a:link, a:visited, a:active { text-decoration: none; color: #007799; }
a:hover { text-decoration: underline; color: #E98219; }

th a:link, th a:visited, th a:active { text-decoration: underline; color: #FFDD33; font-weight: bold; }
th a:hover { text-decoration: underline; color: #E98219; font-weight: bold; }

th.smalltitle { font-weight: bold; color: #FFDD33; background-color: #020725; white-space: nowrap; font-size: 10px; }
th.smalltitle a:link, th.smalltitle a:visited, th.smalltitle a:active { text-decoration: underline; color: #FFDD33; font-weight: bold; font-size: 10px; }
th.smalltitle a:hover { color: #E98219; font-weight: bold; font-size: 10px; text-decoration: underline; }

th.footer { color: #FFDD33; text-align: right; background-color: #020725; white-space: nowrap; font-weight: normal; }
th.footer a:link, th.footer a:visited, th.footer a:active { color: #FFDD33; text-decoration: underline;  font-weight: normal; }
th.footer a:hover { color: #E98219; text-decoration: underline; font-weight: normal; }
...
.maintitle { font-size: 18px; font-weight: bold; color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR1'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR1'] : '') . '; }
...
a.credits {font-size: 10px; color: #999999; }
...
.menu a:hover { text-decoration: underline; font-size: ' . ((isset($this->_tpldata['.'][0]['T_FONTSIZE1'])) ? $this->_tpldata['.'][0]['T_FONTSIZE1'] : '') . 'px; color: #' . ((isset($this->_tpldata['.'][0]['T_BODY_HLINK'])) ? $this->_tpldata['.'][0]['T_BODY_HLINK'] : '') . '; }
...
.rowth {
 ...
 white-space: nowrap;
 background-image: url(' . ((isset($this->_tpldata['.'][0]['TEMPLATE_PATH'])) ? $this->_tpldata['.'][0]['TEMPLATE_PATH'] : '') . '/images/cellpic1.gif);
 height: 28px;
}
.rowfb{
	background:#000000;
