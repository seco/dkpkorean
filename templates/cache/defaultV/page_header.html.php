...
echo '
<link rel="shortcut icon" href="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'templates/defaultV/images/favicon.png" type="image/png">
<link rel="icon" href="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'templates/default/imagesV/favicon.png" type="image/png">
...
#rrs_news div.content {
	margin-bottom : 10px;
	border: none;
	color: #' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR2'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR2'] : '') . ';
	text-decoration: none;
	font-size: 10px;
	margin: 0px;
	padding: 10px;
...
#rrs_news div.title {
	...
	font-size: 10px;
	color:#' . ((isset($this->_tpldata['.'][0]['T_FONTCOLOR2'])) ? $this->_tpldata['.'][0]['T_FONTCOLOR2'] : '') . ';
	background:#' . ((isset($this->_tpldata['.'][0]['T_TR_COLOR2'])) ? $this->_tpldata['.'][0]['T_TR_COLOR2'] : '') . ';
