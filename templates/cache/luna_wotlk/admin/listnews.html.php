...
echo '
  <tr class="' . ((isset($this->_tpldata['news_row.'][$_news_row_i]['ROW_CLASS'])) ? $this->_tpldata['news_row.'][$_news_row_i]['ROW_CLASS'] : '') . '">
    <td width="16" nowrap="nowrap" align="center"><a href="' . ((isset($this->_tpldata['news_row.'][$_news_row_i]['U_VIEW_NEWS'])) ? $this->_tpldata['news_row.'][$_news_row_i]['U_VIEW_NEWS'] : '') . '"><img src="' . ((isset($this->_tpldata['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_tpldata['.'][0]['EQDKP_ROOT_PATH'] : '') . 'images/glyphs/edit.png" width="16" height="16" alt="Edit" /></a></td>
