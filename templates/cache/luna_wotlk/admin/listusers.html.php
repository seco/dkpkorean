...
<script type="text/javascript">
  ...
  {
      for(var x=0;x<document.post.elements.length;x++)
      {
          var y=document.post.elements[x];
          if(y.id!=\'all_nr\' && y.name==\'user_id[]\' && y.value!=\'' . ((isset($this->_tpldata['.'][0]['MY_OWN_ID'])) ? $this->_tpldata['.'][0]['MY_OWN_ID'] : '') . '\')
          {
              y.checked=document.post.all_nr.checked;
          }
      }
  }

  function AskAdminPermission(checkb)
  {
  	if(checkb.value==\'' . ((isset($this->_tpldata['.'][0]['MY_OWN_ID'])) ? $this->_tpldata['.'][0]['MY_OWN_ID'] : '') . '\')
  	{
  	 	if(!confirm(\'' . ((isset($this->_tpldata['.'][0]['L_MM_User_Confirm'])) ? $this->_tpldata['.'][0]['L_MM_User_Confirm'] : ((isset($user->lang['MM_User_Confirm'])) ? $user->lang['MM_User_Confirm'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'MM_User_Confirm'))) . ' 	}')) . '\'))
  	 	{
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <th align="center" colspan="7">' . ((isset($this->_tpldata['.'][0]['L_MANAGE_USERS'])) ? $this->_tpldata['.'][0]['L_MANAGE_USERS'] : ((isset($user->lang['MANAGE_USERS'])) ? $user->lang['MANAGE_USERS'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'MANAGE_USERS'))) . ' 	}')) . '</th>
  </tr>
  <tr>
    <th align="center" width="25" nowrap="nowrap"><input type="checkbox" name="all_nr" value="all_nr" onclick="AllMessages(this.form);" /></th>
    <th align="left" width="40%"><a href="' . ((isset($this->_tpldata['.'][0]['U_MANAGE_USERS'])) ? $this->_tpldata['.'][0]['U_MANAGE_USERS'] : '') . 'o=' . ((isset($this->_tpldata['.'][0]['O_USERNAME'])) ? $this->_tpldata['.'][0]['O_USERNAME'] : '') . '&amp;start=' . ((isset($this->_tpldata['.'][0]['START'])) ? $this->_tpldata['.'][0]['START'] : '') . '">' . ((isset($this->_tpldata['.'][0]['L_USERNAME'])) ? $this->_tpldata['.'][0]['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'USERNAME'))) . ' 	}')) . '</a></th>
	<th align="left" width="35%">' . ((isset($this->_tpldata['.'][0]['L_ACTIVE_CHAR'])) ? $this->_tpldata['.'][0]['L_ACTIVE_CHAR'] : ((isset($user->lang['ACTIVE_CHAR'])) ? $user->lang['ACTIVE_CHAR'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'ACTIVE_CHAR'))) . ' 	}')) . '</th>
	<th align="left" width="100"><a href="' . ((isset($this->_tpldata['.'][0]['U_MANAGE_USERS'])) ? $this->_tpldata['.'][0]['U_MANAGE_USERS'] : '') . 'o=' . ((isset($this->_tpldata['.'][0]['O_EMAIL'])) ? $this->_tpldata['.'][0]['O_EMAIL'] : '') . '&amp;start=' . ((isset($this->_tpldata['.'][0]['START'])) ? $this->_tpldata['.'][0]['START'] : '') . '">' . ((isset($this->_tpldata['.'][0]['L_EMAIL'])) ? $this->_tpldata['.'][0]['L_EMAIL'] : ((isset($user->lang['EMAIL'])) ? $user->lang['EMAIL'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'EMAIL'))) . ' 	}')) . '</a></th>
...
echo '
  <tr class="' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['ROW_CLASS'])) ? $this->_tpldata['users_row.'][$_users_row_i]['ROW_CLASS'] : '') . '">
    <td width="25" align="center" nowrap="nowrap"><input type="checkbox" name="user_id[]" onclick="AskAdminPermission(this);" value="' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['USER_ID'])) ? $this->_tpldata['users_row.'][$_users_row_i]['USER_ID'] : '') . '" /></td>
    <td width="40%"><a href="' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['U_MANAGE_USER'])) ? $this->_tpldata['users_row.'][$_users_row_i]['U_MANAGE_USER'] : '') . '" style="' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['NAME_STYLE'])) ? $this->_tpldata['users_row.'][$_users_row_i]['NAME_STYLE'] : '') . '">' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['USERNAME'])) ? $this->_tpldata['users_row.'][$_users_row_i]['USERNAME'] : '') . '</a></td>
    <td width="35%">' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['CHARAKTER'])) ? $this->_tpldata['users_row.'][$_users_row_i]['CHARAKTER'] : '') . '</td>
    <td width="100"><a href="' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['U_MAIL_USER'])) ? $this->_tpldata['users_row.'][$_users_row_i]['U_MAIL_USER'] : '') . '">' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['EMAIL'])) ? $this->_tpldata['users_row.'][$_users_row_i]['EMAIL'] : '') . '</a></td>
    ...
    <td width="60" align="center" nowrap="nowrap">' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['ACTIVE'])) ? $this->_tpldata['users_row.'][$_users_row_i]['ACTIVE'] : '') . '</td>
    <td width="60" align="center" nowrap="nowrap">' . ((isset($this->_tpldata['users_row.'][$_users_row_i]['ONLINE'])) ? $this->_tpldata['users_row.'][$_users_row_i]['ONLINE'] : '') . '</td>
  </tr>
  ';}}
// END users_row
echo '
  <tr>
    <th colspan="7" class="footer">' . ((isset($this->_tpldata['.'][0]['LISTUSERS_FOOTCOUNT'])) ? $this->_tpldata['.'][0]['LISTUSERS_FOOTCOUNT'] : '') . '</th>
  </tr>
</table>
<table width="100%" border="0" cellspacing="1" cellpadding="2" class="borderless">
  <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <th align="center">' . ((isset($this->_tpldata['.'][0]['L_MASS_UPDATE'])) ? $this->_tpldata['.'][0]['L_MASS_UPDATE'] : ((isset($user->lang['MASS_UPDATE'])) ? $user->lang['MASS_UPDATE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'MASS_UPDATE'))) . ' 	}')) . '</th>
  </tr>
  <tr>
...
echo '
 <tr>
   <th width="100%">' . ((isset($this->_tpldata['permissions_row.'][$_permissions_row_i]['GROUP'])) ? $this->_tpldata['permissions_row.'][$_permissions_row_i]['GROUP'] : '') . ':</td>
</tr>
<tr>
