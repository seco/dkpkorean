...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td width="100" align="right" nowrap="nowrap" class="row1">' . ((isset($this->_tpldata['.'][0]['L_NAME'])) ? $this->_tpldata['.'][0]['L_NAME'] : ((isset($user->lang['NAME'])) ? $user->lang['NAME'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'NAME'))) . ' 	}')) . ':</td>
    ...
    ';// IF IS_NOT_MULTIDKP
if ($this->_tpldata['.'][0]['IS_NOT_MULTIDKP']) { 
echo '
...
echo '
    	<input type=hidden name="member_earned" value="' . ((isset($this->_tpldata['.'][0]['MEMBER_EARNED'])) ? $this->_tpldata['.'][0]['MEMBER_EARNED'] : '') . '">
    ';// ENDIF
}
echo '
  </tr>
  <tr>
    <td width="100" align="right" nowrap="nowrap" class="row1">' . ((isset($this->_tpldata['.'][0]['L_RACE'])) ? $this->_tpldata['.'][0]['L_RACE'] : ((isset($user->lang['RACE'])) ? $user->lang['RACE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'RACE'))) . ' 	}')) . ':</td>
    <td width="50%" nowrap="nowrap" class="row2">
...
echo '
      <input type=hidden name="member_spent" value="' . ((isset($this->_tpldata['.'][0]['MEMBER_SPENT'])) ? $this->_tpldata['.'][0]['MEMBER_SPENT'] : '') . '">
    ';// ENDIF
}
echo '
  </tr>
  <tr>
    <td width="100" align="right" nowrap="nowrap" class="row1">' . ((isset($this->_tpldata['.'][0]['L_CLASS'])) ? $this->_tpldata['.'][0]['L_CLASS'] : ((isset($user->lang['CLASS'])) ? $user->lang['CLASS'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'CLASS'))) . ' 	}')) . ':</td>
    <td width="50%" nowrap="nowrap" class="row2">
...
echo '
    	<input type=hidden name="member_adjustment" value="' . ((isset($this->_tpldata['.'][0]['MEMBER_ADJUSTMENT'])) ? $this->_tpldata['.'][0]['MEMBER_ADJUSTMENT'] : '') . '">
    ';// ENDIF
}
echo '
  </tr>
  <tr>
    <td width="100" align="right" nowrap="nowrap" class="row1">' . ((isset($this->_tpldata['.'][0]['L_LEVEL'])) ? $this->_tpldata['.'][0]['L_LEVEL'] : ((isset($user->lang['LEVEL'])) ? $user->lang['LEVEL'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'LEVEL'))) . ' 	}')) . ':</td>
    <td width="50%" nowrap="nowrap" class="row2"><input type="text" name="member_level" size="3" maxlength="3" value="' . ((isset($this->_tpldata['.'][0]['MEMBER_LEVEL'])) ? $this->_tpldata['.'][0]['MEMBER_LEVEL'] : '') . '" class="input" />' . ((isset($this->_tpldata['.'][0]['FV_MEMBER_LEVEL'])) ? $this->_tpldata['.'][0]['FV_MEMBER_LEVEL'] : '') . '</td>
    ';// IF IS_NOT_MULTIDKP
if ($this->_tpldata['.'][0]['IS_NOT_MULTIDKP']) { 
echo '
...
echo '
  ...
  <tr>
    <td width="100" align="right" nowrap="nowrap" class="row1">' . ((isset($this->_tpldata['.'][0]['L_MEMBER_RANK'])) ? $this->_tpldata['.'][0]['L_MEMBER_RANK'] : ((isset($user->lang['MEMBER_RANK'])) ? $user->lang['MEMBER_RANK'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'MEMBER_RANK'))) . ' 	}')) . '</td>
