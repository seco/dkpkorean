...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  ' . ((isset($this->_tpldata['.'][0]['SEARCH'])) ? $this->_tpldata['.'][0]['SEARCH'] : '') . ' <form action="' . ((isset($this->_tpldata['.'][0]['SEARCH_ITEM_SITE'])) ? $this->_tpldata['.'][0]['SEARCH_ITEM_SITE'] : '') . '" method="get">
  	<input name="search" class="input" type="text" size="40" />
  </td>
  </tr>

<input type="hidden" name="search_type" value="itemname">
  </form>
...
echo '
  <tr class="' . ((isset($this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'])) ? $this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'] : '') . '" onmouseover="this.className=\'rowHover\';" onmouseout="this.className=\'' . ((isset($this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'])) ? $this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'] : '') . '\';">
    ...
    ';// IF S_HISTORY
if ($this->_tpldata['.'][0]['S_HISTORY']) { 
echo '<td width="100" nowrap="nowrap">' . ((isset($this->_tpldata['items_row.'][$_items_row_i]['BUYER'])) ? $this->_tpldata['items_row.'][$_items_row_i]['BUYER'] : '') . '</td>';// ENDIF
}
echo '
