      ...
      <table border="0" cellspacing="0" cellpadding="3" align="center" class="borderless">
        ...
        <tr>
          <td class="row1" colspan="2" valign="middle">
            ' . ((isset($this->_tpldata['.'][0]['L_REMEMBER_PASSWORD'])) ? $this->_tpldata['.'][0]['L_REMEMBER_PASSWORD'] : ((isset($user->lang['REMEMBER_PASSWORD'])) ? $user->lang['REMEMBER_PASSWORD'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'REMEMBER_PASSWORD'))) . ' 	}')) . ': <input type="checkbox" name="auto_login" class="input" />
          </td>
        </tr>
      </table>
    </td>
