...
echo '
  ...
  <tr>
	...
	<b>' . ((isset($this->_tpldata['.'][0]['L_STARTING_DATE'])) ? $this->_tpldata['.'][0]['L_STARTING_DATE'] : ((isset($user->lang['STARTING_DATE'])) ? $user->lang['STARTING_DATE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'STARTING_DATE'))) . ' 	}')) . ':</b> ' . ((isset($this->_tpldata['.'][0]['DATEPICK_DATE_FROM'])) ? $this->_tpldata['.'][0]['DATEPICK_DATE_FROM'] : '') . '
    </td>
    <td width="50%" class="row2" align="center">
	<b>' . ((isset($this->_tpldata['.'][0]['L_ENDING_DATE'])) ? $this->_tpldata['.'][0]['L_ENDING_DATE'] : ((isset($user->lang['ENDING_DATE'])) ? $user->lang['ENDING_DATE'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'ENDING_DATE'))) . ' 	}')) . ':</b> ' . ((isset($this->_tpldata['.'][0]['DATEPICK_DATE_TO'])) ? $this->_tpldata['.'][0]['DATEPICK_DATE_TO'] : '') . '
    </td>
  </tr>
  <tr>
