...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  <tr>
    <th align="left" rowspan="1" width="100%"><a href="' . ((isset($this->_tpldata['.'][0]['U_STATS'])) ? $this->_tpldata['.'][0]['U_STATS'] : '') . 'o=' . ((isset($this->_tpldata['.'][0]['O_NAME'])) ? $this->_tpldata['.'][0]['O_NAME'] : '') . '&amp;show=' . ((isset($this->_tpldata['.'][0]['SHOW'])) ? $this->_tpldata['.'][0]['SHOW'] : '') . '">' . ((isset($this->_tpldata['.'][0]['L_NAME'])) ? $this->_tpldata['.'][0]['L_NAME'] : ((isset($user->lang['NAME'])) ? $user->lang['NAME'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'NAME'))) . ' 	}')) . '</a></th>
    ...
    <th class="smalltitle" rowspan="1"><a href="' . ((isset($this->_tpldata['.'][0]['U_STATS'])) ? $this->_tpldata['.'][0]['U_STATS'] : '') . 'o=' . ((isset($this->_tpldata['.'][0]['O_CURRENT'])) ? $this->_tpldata['.'][0]['O_CURRENT'] : '') . '&amp;show=' . ((isset($this->_tpldata['.'][0]['SHOW'])) ? $this->_tpldata['.'][0]['SHOW'] : '') . '">' . ((isset($this->_tpldata['.'][0]['L_CURRENT'])) ? $this->_tpldata['.'][0]['L_CURRENT'] : ((isset($user->lang['CURRENT'])) ? $user->lang['CURRENT'] : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'CURRENT'))) . ' 	}')) . '</a></th>
  </tr>
  <tr>
...
echo '
  <tr class="' . ((isset($this->_tpldata['stats_row.'][$_stats_row_i]['ROW_CLASS'])) ? $this->_tpldata['stats_row.'][$_stats_row_i]['ROW_CLASS'] : '') . '">
    ...
    <td class="' . ((isset($this->_tpldata['stats_row.'][$_stats_row_i]['C_CURRENT'])) ? $this->_tpldata['stats_row.'][$_stats_row_i]['C_CURRENT'] : '') . '">' . ((isset($this->_tpldata['stats_row.'][$_stats_row_i]['CURRENT'])) ? $this->_tpldata['stats_row.'][$_stats_row_i]['CURRENT'] : '') . '</td>
  </tr>
  ';}}
// END stats_row
echo '
