 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2009-03-03 23:46:23 +0100 (Di, 03 Mrz 2009) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 4081 $
 * 
 * $Id: jquery.class.php 4081 2009-03-03 22:46:23Z wallenium $
 */
  ...
  class jquery {
    ...
    */
    function Dialog_Confirm($name, $text, $jscode){
      ...
      $jscode = "function submit_".$name."(v,m){
                ...
                function ".$name."(){
                  $.prompt('".$text."', {
                            buttons:{ ".$user->lang['cl_bttn_ok'].": true, ".$user->lang['cl_bttn_cancel'].": false },
                            submit: submit_".$name.",
                            prefix:'cleanblue',
                            show:'slideDown'}
                          );
    ...
    */  
    function Calendar($name, $value, $jscode='', $format='dd.mm.yy'){
      ...
      $jscode = "<script>
                  jQuery(function($){
  				          $('#".$name."').datepicker({showOn: 'button', buttonImage: '".$this->path."images/calendar.png', buttonImageOnly: true, dateFormat: '".$format."'}); 
                  });
                  </script>";
      return $html.$jscode;
    }
