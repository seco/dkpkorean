 ...
 * $Rev: 274 $ $Date: 2008-09-15 01:19:07 +0200 (Mo, 15 Sep 2008) $
 */
...
class ctrt_Plugin_Class extends EQdkp_Plugin
{
    ...
    function ctrt_plugin_class($pm)
    {
        ...
        // Addition PLUS Information
        $this->additional_data = array(
      		  'author' => 'loganfive',
          	'description' => $user->lang['ctrt_short_desc'],
          	'long_description'  => $user->lang['ctrt_long_desc'],
...
//      $this->add_menu('main_menu1', $this->gen_main_menu1());
         ...
         */
        include($eqdkp_root_path.'plugins/'.$this->get_data('path').'/config_data.php');
