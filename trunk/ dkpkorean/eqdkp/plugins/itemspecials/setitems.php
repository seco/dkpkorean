 ...
 * @version     $Rev: 4171 $
 * 
 * $Id: setitems.php 4171 2009-03-10 18:31:08Z wallenium $
 */
...
foreach($classname as $clid=>$clname){
  $tpl->assign_block_vars('CLASSES', array(
                'NAME'      => $clname,
                'ID'        => $clid,
                'SELECTED'  => ($_GET['class'] == $clid) ? "selected=selected" : "",
...
// Header Image
$header_image_path      = $eqdkp_root_path.'plugins/itemspecials/games/'.$rpgfolders->GameName().'/images/sp'.$_GET['class'].'.jpg';
...
$tpl->assign_vars(array(
        ...
        'IS_CLASS_ID'     => $_GET['class'],
        'IS_CLASSHEADIMG' => $header_image_img,
        'HEADER_CLS_TXT'	=> ($_GET['class'] != "") ? $classname[$class]  : $user->lang['is_usermenu_Setitems'],
