 ...
 * -----------------------------------------------------------------------
 * Began:       May 7, 2007
 * Date:        $Date: 2009-03-11 14:28:31 +0100 (Mi, 11 Mrz 2009) $
 * -----------------------------------------------------------------------
 * @author      $Author: sz3 $
 ...
 * @version     $Rev: 4195 $
 * 
 * $Id: plus.functions.php 4195 2009-03-11 13:28:31Z sz3 $
 */
...
function renameRacetoenglish($class)
{
	...
	if($eqdkp->config['default_game'] == 'WoW')
	{
		switch ($class)
		{
			...
			case "췰佃"       	: $_return = "Gnome";break;
			case "痢依橓? 		: $_return = "Human";break;
			case "콰燮?        : $_return = "Dwarf";break;
			case "孔杷迹 凞橫"  : $_return = "Night Elf";break;
			case "勒鏑?       	: $_return = "Troll";break;
			case "袞鍊潗"       : $_return = "Undead";break;
			case "蕎?     		: $_return = "Orc";break;
			case "腦債孼"      	: $_return = "Tauren";break;
			case "쿨孼彦"     	: $_return = "Draenei";break;
			case "憾荻設渾 凞橫": $_return = "Blood Elf";break;			
		 }
	}
