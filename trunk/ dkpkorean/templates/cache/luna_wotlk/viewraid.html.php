...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr rowspan="2"><td> ' . ((isset($this->_tpldata['.'][0]['EVENT_ICON'])) ? $this->_tpldata['.'][0]['EVENT_ICON'] : '') . ' </td>
	<td align=left width="100%">
		  	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		  <tr>
		    <td align="left" width="100%" colspan="2"><b>' . ((isset($this->_tpldata['.'][0]['EVENT_NAME'])) ? $this->_tpldata['.'][0]['EVENT_NAME'] : '') . '</b></td>
		  </tr>
		  <tr>
...
echo '
  <tr class="' . ((isset($this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'])) ? $this->_tpldata['items_row.'][$_items_row_i]['ROW_CLASS'] : '') . '">
    <td width="120" nowrap="nowrap">' . ((isset($this->_tpldata['items_row.'][$_items_row_i]['BUYER'])) ? $this->_tpldata['items_row.'][$_items_row_i]['BUYER'] : '') . '</td>
...
echo '
 ...
 ';// IF ITEMHISTORY_DIA
if ($this->_tpldata['.'][0]['ITEMHISTORY_DIA']) { 
echo '
<br/>
<table width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
 ...
 <tr>
 <td class="row2">
 ' . ((isset($this->_tpldata['.'][0]['CLASS_PERCENT_CHART'])) ? $this->_tpldata['.'][0]['CLASS_PERCENT_CHART'] : '') . '
 </td>
 </tr>
</table>
';// ENDIF
