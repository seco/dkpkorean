 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2009-07-26 19:55:37 +0200 (So, 26 Jul 2009) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 5366 $
 * 
 * $Id: module.php 5366 2009-07-26 17:55:37Z wallenium $
 */
  ...
  function weather_module()
  {
    ...
    if(!($xml)){
      ...
      $wdata['current'] = array(
				...
				"humidity"        => utf8_decode((string)$xml->weather->current_conditions->humidity['data']),
				"humidity_array"  => explode(": ",(string)$xml->weather->current_conditions->humidity['data']),
